# -*- coding: utf-8 -*-
from lab11.gpalgorithm import Controller
    ...
    def run(self):
        while True:
            ...
            if choice == '1':
                ...
                self.__controller.run(nrOfIndividuals, iterations, trainingSize, testingSize, mutationProbability,
                                      crossoverProbability, epsilon)
            else:
                return
