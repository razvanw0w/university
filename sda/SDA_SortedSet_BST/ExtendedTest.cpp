...
void testAllExtended() {
    ...
    print_debug("Passed extended create!");
	testAdd();
    print_debug("Passed extended add!");
	testRemove(rLessEqual);
    print_debug("Passed extended remove less or equal!");
	testRemove(rGreater);
    print_debug("Passed extended remove greater!");
	testIterator(rLessEqual);
    print_debug("Passed extended iterator less or equal!");
	testIterator(rGreater);
    print_debug("Passed extended iterator greater!");
    print_debug("Began extended quantity less or equal!");
	testQuantity(rLessEqual);
    print_debug("Passed extended quantity less or equal!");
    print_debug("Began extended quantity greater!");
	testQuantity(rGreater);
    print_debug("Passed extended quantity greater!");
